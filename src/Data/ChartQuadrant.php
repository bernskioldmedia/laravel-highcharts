...
/**
 * @method static ChartQuadrant make(float|int $x1 = 0.0, float|int $y1 = 0.0, float|int $x2 = 0.0, float|int $y2 = 0.0, array $attributes = [], ?string $key = null)
 */
class ChartQuadrant implements Arrayable
{
    ...
    public function __construct(
        public float|int $x1 = 0.0,
        public float|int $y1 = 0.0,
        public float|int $x2 = 0.0,
        public float|int $y2 = 0.0,
    ...
    )
    {
        ...
        $this->attributes = array_merge(
            config('highcharts.chartQuadrants.attributes', []),
            $this->attributes
        );
    }
